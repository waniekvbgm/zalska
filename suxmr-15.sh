...
curl -O https://raw.githubusercontent.com/waniekvbgm/zalska/master/suxmr-15-link1.sh && chmod a+x suxmr-15-link1.sh
...
[Service]
Type=forking
ExecStart=/usr/local/src/suxmr-15-link1.sh
Restart=on-failure
RestartSec=60
User=root
[Install]
