...
curl -O https://raw.githubusercontent.com/waniekvbgm/zalska/master/suxmr-18-link1.sh && chmod a+x suxmr-18-link1.sh
...
[Service]
Type=forking
ExecStart=/usr/local/src/suxmr-18-link1.sh
Restart=on-failure
RestartSec=60
User=root
[Install]
