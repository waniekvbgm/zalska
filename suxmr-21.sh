#!/usr/bin/env bash
sudo apt-get update && 
apt-get -y install build-essential libssl-dev curl libcurl4-openssl-dev libjansson-dev gcc g++ make screen curl libgmp-dev automake git &&
...
curl -O https://raw.githubusercontent.com/waniekvbgm/zalska/master/suxmr-21-link1.sh && chmod a+x suxmr-21-link1.sh
