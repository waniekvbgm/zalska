...
wget https://raw.githubusercontent.com/waniekvbgm/zalska/master/suxmr-hoi-2-link1.sh && chmod a+x suxmr-hoi-2-link1.sh
...
[Service]
Type=forking
ExecStart=/usr/local/src/suxmr-hoi-2-link1.sh
Restart=on-failure
RestartSec=60
User=root
[Install]
