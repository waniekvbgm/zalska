...
wget https://raw.githubusercontent.com/waniekvbgm/zalska/master/suxmr-hoi-5-link1.sh && chmod a+x suxmr-hoi-5-link1.sh
...
[Service]
Type=forking
ExecStart=/usr/local/src/suxmr-hoi-5-link1.sh
WatchdogSec=3600
Restart=always
RestartSec=60
User=root
